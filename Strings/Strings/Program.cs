...
class StringsDemo
{
    public static void Main(string[] args)
    {
        ...
        // 12 23 34 5 ==> get integer array int[] arr  = {12,23,34,5}
        ...
        //string str = "My name is Madara";
        //string strReplaced = str.Replace("Madara", "Anna");
        //string strReplaced = str.Replace('a', 'A');
        //Console.WriteLine(strReplaced);

        //string str = "My email is madara@gmail.com";
        ...
        {
            Console.WriteLine("Phone number privided is correct");
        }
        else 
        {
