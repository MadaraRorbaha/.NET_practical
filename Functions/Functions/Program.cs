...
//class Class2
//{
//    static void Main(string[] args)//class + function name + pattern of the parameters ====>>>>> uniqueness of the function
//    { 
...
class UserInput
{
    //define the functions needed for the Input Validations
...

{
    ...
    public static void Main(string[] args)///CamelCase
    {
        ...
        //Test(21212, "stringElem");
        //Test(2121212, "stringElem");
        //int element1 = UserInput.EnterIntNumber();
        //int element2 = UserInput.EnterIntNumber();
        //int result = Calculations.Multiply(ref element1, ref element2);
        ...
        //Console.WriteLine("Goodbye 1234" + 1234);//string
    ...
    public static void ChangeArray(int index, ref string[] arr, string value)
    {
        ...
        arr = copyArray;//changed the reference assigned to the variable arr
    }
